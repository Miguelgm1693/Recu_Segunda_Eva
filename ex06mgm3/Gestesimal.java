...
public class Gestesimal {
    ...
    public static void main(String[] args) {
        a.add(new Articulo("LOF", "Lente esférica", 20, 30, 15));
        a.add(new Articulo("LEN", "Lentillas", 10, 25, 35));
        a.add(new Articulo("MDO", "Montura Graduado", 32, 54, 100));
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 1: // Listado /////////////////////////////////////////////
                    ...
                    double sumaPrecioCompra = 0;
                    double sumaPrecioVenta = 0;

                    for (Articulo aux : a) {
                        System.out.println(aux);
                        sumaPrecioCompra += aux.getPrecioDeCompra();
                        sumaPrecioVenta += aux.getPrecioDeVenta();
                    }

                    DecimalFormat df = new DecimalFormat("0.00");
                    System.out.println("Total Artículos: " + a.size());
                    System.out.println("Precio medio de compra: " + df.format(sumaPrecioCompra / a.size()) + "€");
                    System.out.println("Precio medio de venta: " + df.format(sumaPrecioVenta / a.size()) + "€");
                    System.out.println("Beneficio: " + df.format(sumaPrecioVenta / a.size() - sumaPrecioCompra / a.size()) + "€");
                    break;
                ...
                case 7: //bajo stock
                    ...
                    int stockBajo = Integer.parseInt(s.nextLine());
                    for (Articulo articulo : a) {
                        if (articulo.getStock() <= stockBajo) {
